...
Only requiring some minor changes is eve.cpp.
...
Changes to eve.cpp
----------------------
eve.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
