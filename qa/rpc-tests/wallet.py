...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 EVE, node2 has none. 
#   d) node0 sends 21 EVE to node2, in two transactions (11 EVE, then 10 EVE).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 EVE from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 EVE in block rewards plus fees, but
