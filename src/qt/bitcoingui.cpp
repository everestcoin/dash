    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Eve Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Eve address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and eve: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Eve Core"), this);
    aboutAction->setStatusTip(tr("Show information about Eve Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Eve"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Eve addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Eve addresses"));
    ...
    openAction->setStatusTip(tr("Open a eve: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Eve Core help message to get a list with possible Eve command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Eve Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Eve network", "", count));
}
...
{
    QString strTitle = tr("Eve Core"); // default title
