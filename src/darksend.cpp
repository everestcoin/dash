...
/* *** BEGIN DARKSEND MAGIC - EVE **********
    Copyright (c) 2014-2015, Eve Developers
        eduffield - evan@everestcoin.io
        udjinm6   - udjinm6@everestcoin.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Eve and make it unusable. To
