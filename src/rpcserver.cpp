...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Eve features */
    { "eve",               "masternode",             &masternode,             true,      true,       false },
    { "eve",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "eve",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "eve",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "eve",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "eve",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "eve",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "eve",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use eved, or the -server option to eve-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> eve-cli " + methodname + " " + args + "\n";
}
