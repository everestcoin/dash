...
RESOURCES += src/qt/eve.qrc src/qt/eve_locale.qrc
TRANSLATIONS += src/qt/locale/eve_bg.ts \
                src/qt/locale/eve_de.ts \
                src/qt/locale/eve_en.ts \
                src/qt/locale/eve_es.ts \
                src/qt/locale/eve_fi.ts \
                src/qt/locale/eve_fr.ts \
                src/qt/locale/eve_it.ts \
                src/qt/locale/eve_ja.ts \
                src/qt/locale/eve_pl.ts \
                src/qt/locale/eve_pt.ts \
                src/qt/locale/eve_ru.ts \
                src/qt/locale/eve_sk.ts \
                src/qt/locale/eve_sv.ts \
                src/qt/locale/eve_vi.ts \
                src/qt/locale/eve_zh_CN.ts \
                src/qt/locale/eve_zh_TW.ts
